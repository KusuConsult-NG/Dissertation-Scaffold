...
import { getUser as getFirestoreUser, updateUser as updateFirestoreUser, createUser as createFirestoreUser } from "./firestore";
...
export const createUser = createFirestoreUser;
