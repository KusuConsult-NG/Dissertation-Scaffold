...
export const nigerianLocations: StateData = {
    ...
    "Akwa Ibom": [
        ...
        "Oruk Anam", "Ukanafun", "Udung Uko", "Urue-Offong/Oruko", "Uyo", "Uruan"
    ],
    "Anambra": [
    ...
    "Bauchi": [
        ...
        "Tafawa Balewa", "Toro", "Warji", "Zaki", "Gamawa"
    ],
    "Bayelsa": [
    ...
    "Edo": [
        ...
        "Esan West", "Etsako Central", "Etsako East", "Etsako West", "Iguedo",
        "Ikpoba-Okha", "Oredo", "Orhionmwon", "Ovia North-East", "Ovia South-West",
        "Owan East", "Owan West", "Uhunmwonde"
    ],
    "Ekiti": [
        "Ado Ekiti", "Ikere", "Emure", "Gbonyin", "Ido Osi",
        "Ijero", "Ikole", "Ilejemeje", "Irepodun/Ifelodun", "Ise/Orun",
        "Moba", "Oye", "Ekiti East", "Ekiti South-West", "Ekiti West", "Efon"
    ],
    "Enugu": [
    ...
    "Imo": [
        ...
        "Ideato South", "Ikeduru", "Isiala Mbano", "Isu", "Mbaitoli",
        "Ngor Okpala", "Njaba", "Nkwerre", "Nwangele", "Obowo",
        "Oguta", "Ohaji/Egbema", "Okigwe", "Onuimo", "Orlu",
    ...
    "Kaduna": [
        ...
        "Jaba", "Jama'a", "Kachia", "Kaduna North", "Kaduna South",
    ...
    "Kwara": [
        ...
        "Ilorin East", "Ilorin South", "Ilorin West", "Isin", "Kaiama",
    ...
    "Nasarawa": [
        ...
        "Koko", "Lafia", "Nasarawa", "Nasarawa Eggon", "Obi",
        "Toto", "Wamba"
    ],
    "Niger": [
        "Agaie", "Agwara", "Bida", "Borgu", "Bosso",
        "Chanchaga", "Edati", "Gbako", "Gurara", "Katcha",
        "Kontagora", "Lap", "Lavun", "Magama", "Mariga",
    ...
    "Osun": [
        ...
        "Ife Central", "Ife East", "Ife North", "Ife South", "Ifelodun",
    ...
    "Oyo": [
        ...
        "Ibadan South West", "Ido", "Ibarapa Central", "Ibarapa East",
        "Ibarapa North", "Itesiwaju", "Iwajowa", "Kajola", "Lagelu",
        "Ogbomosho North", "Ogbomosho South", "Ogo Oluwa", "Olorunsogo",
        "Oluyole", "Ona Ara", "Orelope", "Ori Ire", "Oyo East",
    ...
    "Yobe": [
        ...
        "Geidam", "Gogaram", "Gulani", "Jakusko", "Karasuwa",
